...
#== SETTINGS REGISTRATION =====================================================================================
    ...
    public function get_section_docs_link_url($sectionCode = null, $default = null) {
        $docUrls = apply_filters('wprss_ftp_section_docs_link_urls', array(
            'wprss_settings_ftp_general_section'            => 'http://docs.wprssaggregator.com/general-settings/#general-settings',
            'wprss_settings_ftp_taxonomies_section'         => 'http://docs.wprssaggregator.com/general-settings/#taxonomies',
            'wprss_settings_ftp_authors_section'            => 'http://docs.wprssaggregator.com/general-settings/#authors',
            'wprss_settings_ftp_images_section'             => 'http://docs.wprssaggregator.com/general-settings/#images',
            'wprss_settings_ftp_full_text_section'          => 'http://docs.wprssaggregator.com/general-settings/#full-text-rss',
            'wprss_settings_ftp_namespaces_section'         => 'http://docs.wprssaggregator.com/general-settings/#custom-namespaces',
        ));
